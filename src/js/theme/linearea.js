...
const linearea = function (v) {
  ...
  const skins = {
    Fire: {
      ...
      area_fill_opacity() {
        return (this.layout() === vizuly.viz.layout.OVERLAP) ? 0.7 : 0.9;
      },
    ...
    Sunset: {
      ...
      area_fill_opacity() {
        return (this.layout() === vizuly.viz.layout.OVERLAP) ? 0.8 : 1;
      },
      xAxis_font_weight: 200,
    ...
    Neon: {
      ...
      line_opacity() {
        return (this.layout() === vizuly.viz.layout.STREAM) ? 0.4 : 0.6;
      },
      area_fill() {
        return '#D1F704';
      },
      area_fill_opacity(d, i) {
        return ((i + 1) / this.data().length) *
          ((this.layout() === vizuly.viz.layout.OVERLAP) ? 0.6 : 0.8);
      },
      xAxis_font_weight: 200,
      yAxis_line_stroke: '#FFF',
      yAxis_line_opacity: 0.25,
