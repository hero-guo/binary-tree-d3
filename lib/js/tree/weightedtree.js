...
/*global document*/
var weightedTree = function weightedTree(parent, arr) {
  /***
   * parent父级ID
   * arr自定义事件
   ***/
  var wrap = document.getElementById('wrapper').getBoundingClientRect();
  var properties = {
  ...
  var viz = _component2.default.create(parent, {}, properties, ['node_refresh', 'data_prepped'].concat(arr));
  var scope = viz.scope;
